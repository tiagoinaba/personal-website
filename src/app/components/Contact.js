        ...
        return (
          <section className="contact" id="contact">
            <div className="contact__main">
              ...
              <a
                href="https://www.linkedin.com/in/tiago-inaba-654774123/"
                target="_blank"
                className="contact__main--logo"
              >
                <Image
                  src={linkedinLogo}
                  width={85}
              ...
              <a
                href="https://github.com/tiagoinaba"
                target="_blank"
                className="contact__main--logo"
              >
                <Image
            ...
            <div className="contact__form">
              <p>
                {language === "EN"
                  ? "Or fill in this form and I'll get in touch!"
                  : "Ou preencha este formulário e eu entrarei em contato!"}
              </p>
              <ContactForm />
            </div>
          </section>
